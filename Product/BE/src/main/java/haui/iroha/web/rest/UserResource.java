...
import haui.iroha.web.rest.errors.EmailAlreadyUsedException;
import haui.iroha.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    @GetMapping("/users/getavatarbylogin/{login}")
    public String getAllUsers(@PathVariable(name="login")String login) {
        log.debug("REST request to get a avatar");

        return userService.getAvatarByLogin(login);
    }

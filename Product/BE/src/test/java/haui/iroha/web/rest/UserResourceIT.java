...
import haui.iroha.domain.Authority;
...
import haui.iroha.service.mapper.UserMapper;
import haui.iroha.web.rest.vm.ManagedUserVM;
...
class UserResourceIT {
    ...
    public static User createEntity(EntityManager em) {
        ...
        user.setFullName(DEFAULT_FIRSTNAME);
        user.setAddress(DEFAULT_LASTNAME);
    ...
    void createUser() throws Exception {
        ...
        managedUserVM.setFullname(DEFAULT_FIRSTNAME);
        managedUserVM.setAddress(DEFAULT_LASTNAME);
        ...
        assertPersistedUsers(users -> {
            ...
            assertThat(testUser.getFullName()).isEqualTo(DEFAULT_FIRSTNAME);
            assertThat(testUser.getAddress()).isEqualTo(DEFAULT_LASTNAME);
    ...
    void updateUser() throws Exception {
        ...
        managedUserVM.setFullname(UPDATED_FIRSTNAME);
        managedUserVM.setAddress(UPDATED_LASTNAME);
        ...
        assertPersistedUsers(users -> {
            ...
            assertThat(testUser.getFullName()).isEqualTo(UPDATED_FIRSTNAME);
            assertThat(testUser.getAddress()).isEqualTo(UPDATED_LASTNAME);
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setAddress("hipster");
        ...
        managedUserVM.setAddress(updatedUser.getAddress());
    ...
    void testUserDTOtoUser() {
        ...
        userDTO.setFullname(DEFAULT_FIRSTNAME);
        userDTO.setAddress(DEFAULT_LASTNAME);
        ...
        assertThat(user.getFullName()).isEqualTo(DEFAULT_FIRSTNAME);
        assertThat(user.getAddress()).isEqualTo(DEFAULT_LASTNAME);
    ...
    void testUserToUserDTO() {
        ...
        assertThat(userDTO.getFullname()).isEqualTo(DEFAULT_FIRSTNAME);
        assertThat(userDTO.getAddress()).isEqualTo(DEFAULT_LASTNAME);

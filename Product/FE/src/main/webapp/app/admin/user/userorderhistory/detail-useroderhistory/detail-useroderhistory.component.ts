...
@Component({
  selector: 'jhi-detail-useroderhistory',
  templateUrl: './detail-useroderhistory.component.html',
  styleUrls: ['./detail-useroderhistory.component.scss']
})
export class DetailUseroderhistoryComponent implements OnInit {

...
import haui.iroha.service.dto.PasswordChangeDTO;
import haui.iroha.web.rest.errors.*;
import haui.iroha.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResource {
    ...
    @PutMapping(value = "/account/updateAvatar", consumes = {"multipart/form-data"})
    public String updateProducts(@RequestParam("login") String login,
        ...
        String img = userRepository.getAvatarByLogin(login);
        if(image != null){
        ...
        userService.updateAvatar(login,img);
        return "OK";
    }

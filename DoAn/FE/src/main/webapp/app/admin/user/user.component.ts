...
import { UserManagementDeleteDialogComponent } from '../user-management/delete/user-management-delete-dialog.component';
...
export class UserComponent implements OnInit {
  ...
  private onSuccess(users: User[] | null, headers: HttpHeaders): void {
    ...
    for (let i=0;i<users.length;i++){
      this.orderService.getUserOrderCountByLogin(users[i].login).subscribe(res=>{
        this.numberOrder.push(res);
      })
    }
  }
